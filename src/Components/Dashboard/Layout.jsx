...
const Dashboard = ({ children }) => {
  ...
  return (
    <div className="d-flex w-100 min-vh-100">
      ...
      <div
        id="sidebar"
        className={`d-none d-lg-block ${sidebarOpen ? "sidebar-expanded" : "sidebar-collapsed"
          }`}
        style={{
      ...
      >
        <div className="position-fixed vh-100" style={{ backgroundColor: "#0a5353", width: sidebarOpen ? "16.25rem" : "4.2rem", transition: "0.2s" }}>
          <div
          ...
          >
            ...
            <CgRecord style={{height:'1.5rem',width:'1.4rem', cursor: "pointer"}} onClick={toggleSidebar}/>
            {/* <svg
      ...
      >
        <div className="offcanvas-header justify-content-between align-items-center mt-1">
          <h2 className="fw-semibold fs-5" style={{ color: "#0AD8B5" }}>Patient Portal</h2>
          <RxCross2
      ...
      <div className="w-100 d-flex flex-column">
        ...
        <main className="flex-grow-1 ms-2 me-2">{children}</main>
        <Footer />
      </div>
    </div>
  );
